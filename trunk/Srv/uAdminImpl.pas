...
implementation
uses uZsbBmSoapDM,uZsbBmIntf,uZsbBmImpl;
...
function TAdmin.getbackPassword(const sfzh, xm, email: string): Boolean;
var
  dm:TZsbBmSoapDM;
begin
  dm := TZsbBmSoapDM.Create(nil);
...
function TAdmin.SendTestMail(const email, subject, content: string): Boolean;
var
  dm:TZsbBmSoapDM;
begin
  dm := TZsbBmSoapDM.Create(nil);
