<!-- #include file="inc/WebSvcURL.asp" --><HEAD><TITLE>江西科技师范大学专升本报名网</TITLE>
...
<table width="1000" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#A8D9EC" class="bx">
  ...
  <tr>
    ...
    <td width="702" bgcolor="#FFFFFF" class="tr1"><input name="Xm" type="text" id="Xm" value="<%=Xm%>" size="20" maxlength="30" />
    (*不少于2个汉字)</td>
