...
uses
  ...
  uZsbBmIntf,uAdminIntf,EhLibCDS, jpeg,IdMultipartFormData,IdGlobal,GIFImg,
  ...
  IdTCPConnection, IdTCPClient, IdHTTP,ExtCtrls, VCLUnZip, VCLZip, MidasLib;
...
var
  ...
  gb_Czy_ID,gb_Czy_Name,gb_Czy_Level,gb_dwmc:String;
